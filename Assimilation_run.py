...
from read_SWAT_out_ol import read_SWAT_time
from SWAT_output_format_specs_ol import SWAT_output_format_specs
from ASS_utilities_ol import ReadNoSubs
import ASS_module3_Assimilation_ol
import ASS_module1_PrepData_ol
...
OBS_FILE_EM = 'r:\\Projects\\TigerNET\\Kavango\\Kavango_Showcase_new\\In-situ_discharge\\Rundu.csv' #file with in-situ observations used for estimating the error model
#OBS_FILE_EM = 'r:\\Projects\\TigerNET\\Kavango\\Calibration\\Rundu_cal.csv'
ERR_MOD_FILE = 'r:\\Projects\\TigerNET\\Kavango\\Assimilation\\AssFolder_calval_abs\\ErrorModelReach10.txt' #name of the error model file
estimateem = False
writefiles = False
...
#    print(i)
    Issue_Date = date(2014,6,28) + datetime.timedelta(i)
    ...
    if obstoday > 0:
        Ass_Out_Folder = 'r:\\Projects\\TigerNET\\Kavango\\Assimilation\\F_Ass_Out_' + str(Issue_Date) #set the assimilation output folder for each day
