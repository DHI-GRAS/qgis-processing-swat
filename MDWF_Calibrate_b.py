...
class MDWF_Calibrate_b(GeoAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        self.addParameter(ParameterFile(MDWF_Calibrate_b.OBS_FILE, "File with observation data (time, obs, error)", False, False))
    ...
    def processAlgorithm(self, progress):
        ...
        insname, obsblockname = SWAT_PEST_utilities.create_PEST_instruction(SRC_FOLDER, OBS_FILE, OBS_GROUP, SUB_ID, N_SUBS)
