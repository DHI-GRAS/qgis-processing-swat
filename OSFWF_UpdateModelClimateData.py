"""
***************************************************************************
   OSFWF_UpdateModelClimateData.py
-------------------------------------
...
class OSFWF_UpdateModelClimateData(SWATAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        self.addParameter(ParameterFile(OSFWF_UpdateModelClimateData.MODEL_FILE, "Model description file", False, False))
        self.addParameter(ParameterFile(OSFWF_UpdateModelClimateData.PCP_DST_FOLDER, "Precipitation folder", True, False))
    ...
    def processAlgorithm(self, progress):
        ...
        # Get inputs
        model_file = str(self.getParameterValue(OSFWF_UpdateModelClimateData.MODEL_FILE))
        pcp_folder = str(self.getParameterValue(OSFWF_UpdateModelClimateData.PCP_DST_FOLDER))
